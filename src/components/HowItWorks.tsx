...
export function HowItWorks() {
  ...
  return (
    <SectionContainer id="how-it-works">
      ...
      />
      <div className="card-grid-3d grid gap-5 md:grid-cols-3 lg:gap-6">
        {howItWorks.steps.map((item) => (
          <article
            key={item.step}
            className="metal-border card-hover-3d relative flex flex-col overflow-hidden rounded-2xl p-7 shadow-[0_20px_60px_-32px_rgba(0,0,0,0.65)] sm:p-8"
          >
